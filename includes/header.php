...
<!-- ===== Декоративный фон сайта: приглушённое фото на заднем плане.
     Два файла в assets/img/social/: bg-nails-dark.jpg — для тёмной
     темы, bg-nails-light.jpg — инверсия для светлой (см. подробности
     в комментарии у .page-bg-decor в style.css). Переключение картинки
     между темами — через селектор :root[data-theme="light"] .page-bg-decor
     в CSS, тут в разметке ничего менять не нужно. ===== -->
