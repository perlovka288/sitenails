 ...
 * #bookingFormOverlay в index.php. Слот НЕ помечается занятым автоматически
 * — заявка просто сохраняется в "Записи" панели администратора. Мама сама
 * решает, отметить ли это время занятым (в разделе «Записи» или «Свободное
 * время» панели), после того как договорится с клиентом лично.
 */
